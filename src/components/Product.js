  ...
  return (
    <div className>
      <div className=" h-[200px] mb-4 bg-slate-900 relative overflow-hidden group transition">
        ...
        {/* buttons */}
        <div className="absolute top-6 -right-11 group-hover:right-5 p-2 flex flex-col items-center justify-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gray-700 p-2">
          <button onClick={() => addToCart(product, id)}>
            <div className="flex justify-center items-center text-white w-10 h-10 bg-gray-800 hover:bg-slate-900 transition-all duration-300">
